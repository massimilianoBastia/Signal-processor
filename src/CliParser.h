...
namespace configuration {
    ...
    struct SignalProcessorConfiguration {
    ...
    public:
        ...
        inline static SignalProcessorConfiguration parse(int argc, char* argv[]) {
            if (argc < 4 || argc > 7) {
                throw std::invalid_argument("Usage SignalProcessor freqlist outfile samplescount --logfile=<path> --verbose");
            }
